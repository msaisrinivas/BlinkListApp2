      ...
      <Box display={"flex"} justifyContent="center" width="99%" padding={"60px 0px"}>
        <Box  width="84%">
          <Box display={"flex"} justifyContent="flex-start" flexWrap={"wrap"}>
            <Box width="100%" color={'#03314B'} fontSize={"16px"} lineHeight={"20px"} textAlign="left">
            Get the key ideas from
            </Box>
            <Box width="60%" paddingTop={"40px"} textAlign="left">
          ...
          <Box width="100%" padding={"60px 0px"}>
